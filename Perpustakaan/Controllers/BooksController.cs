...
namespace Perpustakaan.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public BooksController(PustakaDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Judul,Penulis,Penerbit,Deskripsi,CategoryId,Status,Gambar")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
